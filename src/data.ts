    ...
    workExperience: [
        {
            ...
            responsibilities: [
                ...
                'Wrote a dropbox clone that allowed importing from 3rd part apps such as Procore, Plangrid, etc..',
                'Wrote a gallery client that allows for advanced AI Based Filtering, Weather Tracking, which is being used by Amazon',
                'Migrated Code Bases from Angular 1 to React.ep Which greatly reduced the number of bugs, and improved application responsiveness.',
                'Wrote build and automation tools',
                'Mentor Junior Developors, helping them with tickets and reviewing their code.',
            ],
        },
        {
        ...
        },
        {
            ...
            responsibilities: [
                ...
                'Was in charge of making many of the design choiconincidenceconincidenceconincidenceces such as the tech stack, deployment cycle, etc..',
